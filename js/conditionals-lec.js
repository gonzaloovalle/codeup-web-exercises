...
//     console.log("in we should delete stuff");
//     // delete everything
//     // double check
...
//     if (color === "red") {
//         return "Stop when approaching a red light at an intersection";
//     } else if (color === "yellow") {
//         return "Slow down when approaching a yellow light at an intersection";
//     } else if (color === "green") {
//         return "Keep going when approaching a green light at an intersection";
//     } else {
//         return "I've never seen that color on a traffic light!";
//     }
// }
//
...
//         alert("You need to have permit 1st!");
//     } else {
