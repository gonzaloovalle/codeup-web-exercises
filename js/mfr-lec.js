...
// let productArray = numbers.map(function(num){
//     return num * 3;
// });
let productArray = numbers.map(num => num * 3);
...
//     return x == false;
// });
const zeroes = binary.filter(x => x == false);
...
const apples = shoppingCarts.reduce(function(sum, numOfApples){
    return sum + numOfApples.apples;
}, 0);
